...
class Products {
  ...
  init() {
    ...
    cartWindowClose.addEventListener("click", () => {
      ...
      cartOverlay.classList.add("cart-overlay-close");
    });
      ...
      menu_container.addEventListener("click", (event) => {
        if (event.target.classList.contains("menu")) {
          ...
          if (selectMenu.dataset.id == "latest") {
            latest_products = productObj.latestProducts();
            productObj.loadProductUserInterFace(
              latest_products,
              "Latest Products"
            );
            ...
            menu_products = productObj.loadProductsByType(
              selectMenu.dataset.id
            );
            productObj.loadProductUserInterFace(
              menu_products,
              selectMenu.dataset.title
            );
          }
        }
        //Cart Actiom
